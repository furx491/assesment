...
sh('ISSUES',['المشكلة','التفاصيل','الأثر على الخطة'],[
 ...
 ['شيت "نجارة سراير" منفصل','347 ساعة شغل نجارة للسراير، متجمّعة من نجارة التنجيد ونجارة النوم والسفرة','⚠ الطاقة لسه مشتركة مع القسمين — لو نجارة السراير عندها عمال مستقلين محتاج عددهم'],
