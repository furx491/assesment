...
sh('ISSUES',['المشكلة','التفاصيل','الأثر على الخطة'],[
 ...
 ['⚠ بابلي فوتيه — 7 وحدات قماشهم يتحدد بكرة','اتجدولوا من 8/9 مش 7/9. ده المعلّق الوحيد.','التسعة التانية شغّالين عادي من 7/9'],
 ['نجارة سراير = قسم مستقل','4 عمال (1 تقديم + 3 تجميع). مخصومين من نجارة التنجيد (42 ← 38) عشان مانخترعش طاقة','⚠ لو الأربعة دول زيادة على الـ42 مش منهم، قوليلي وأرجّع نجارة التنجيد 42'],
 ['الأوقات الناقصة اتملت','روتري سرير: كسوة 13.5س (متوسط رجل فيل سرير) | تريكس فوتيه: تشطيب 0.5س (متوسط برادايس فوتيه)','بأمرك'],
 ...
 ['أوردرات خلصت خالص واتشالت','اوردين ترابيزة كبيرة (5) + اوردين ترابيزة صغيرة (5) + بيلي تي فيونت (16) = 26 وحدة','بأمرك. بيلي بوفيه لسه في الخطة'],
 ['ترابيزات الهالو (13 وحدة)','فاضلها دهانات بس، بتخلص بكرة 8/9','وقت تقديري — مالهاش مسار في الملف'],
